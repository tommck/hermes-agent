...
Currently shipped:
  ...
  - ``bitwarden_vault`` — Bitwarden Vault (`bw` CLI).  See
    ``agent.secret_sources.bitwarden_vault`` for the integration and
    ``hermes_cli.secrets_cli_vault`` for the user-facing setup wizard.
"""
